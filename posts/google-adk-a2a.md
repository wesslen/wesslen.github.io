...
*The guardrail patterns and attack surfaces introduced by multi-agent systems are covered in [What "Guardrail" Actually Means for Agentic AI in Finance](/posts/guardrails). The context engineering infrastructure underlying persistent agent memory is in [Skills & Context Files for Coding Agents](/posts/context). The harness design patterns for long-running agent sessions are in [Harness Design for Long-Running Agents](/posts/agent-harness-design).*
