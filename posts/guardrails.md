...
Whether guardrails are a technical problem with governance implications or a governance problem that requires technical implementation probably determines who should own them inside a financial institution. Across most institutions, neither team has claimed it — and so far, that's been fine. That won't stay true.
